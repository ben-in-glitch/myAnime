...
async function update_episode(episode_id){
...
function renderSeasonRow(data){
    return `<tr class="get_episodes hidden_button" data-id="${data['season_status_id']}">
            <td>
              ...
              <button class="update_season" data-id="${data['season_status_id']}">修改</button>
            </td>
            <td>${data['season']}</td>
        ...
        <td colspan="5">
          <table id="episode_${data['season_status_id']}" style="display:none">
            <thead>
              <tr>
                <td>
                    <button class="append_episode" data-id="${data['season_status_id']}">新增</button>
...
function renderEpisodeRow(data){
    return `<tr>
          <td>
            ...
            <button class="update_episode" data-id="${data['episode_id']}">修改</button>
          </td>
          <td>${data['episode']}</td>
